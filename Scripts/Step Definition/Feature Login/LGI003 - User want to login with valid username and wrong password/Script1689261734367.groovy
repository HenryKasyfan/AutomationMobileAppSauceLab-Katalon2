...
WebUI.callTestCase(findTestCase('Login/Input Password'), [('password') : 123456], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Login/Tap Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Login/Read Error Message'), [('expected') : 'Username and password do not match any user in this service'], 
