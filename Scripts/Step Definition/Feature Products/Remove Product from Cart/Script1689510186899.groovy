...
WebUI.callTestCase(findTestCase('Products/Add Product to Cart'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Products/Remove From Cart'), [:], FailureHandling.STOP_ON_FAILURE)
