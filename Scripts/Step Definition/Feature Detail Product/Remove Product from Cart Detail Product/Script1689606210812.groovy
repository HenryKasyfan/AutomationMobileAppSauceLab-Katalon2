...
WebUI.callTestCase(findTestCase('Products/Open Product by Picture'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Detail Product/Verify Content - Detail Product'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Detail Product/Add Cart'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Detail Product/Remove From Cart'), [:], FailureHandling.STOP_ON_FAILURE)
